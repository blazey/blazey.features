    ...
    public class RegistrarResolver : ISubDependencyResolver
    {
                               ...
                               ComponentModel model, DependencyModel dependency)
        {
            ...
            if (dependency.TargetItemType.IsGenericType &&
                dependency.TargetItemType.GetGenericTypeDefinition() != typeof(object)) return false;
                              ...
                              ComponentModel model, DependencyModel dependency)
        {
            ...
            var typeToConstruct = typeof(object).GetGenericTypeDefinition().MakeGenericType(new[] { candidateType });
